...
<body>
                ...
                <ul class="nav navbar-nav navbar-right navbar-uppercase">
                   ...
                   <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-danger">
                            <li>
                                <a href="newsletter.php"> Sign Up  for newsletter</a>
                            </li>
                            <li>
                                <a href="get.php"> Request an ipainter</a>
                            </li>
                        </ul>
                    </li>
                </ul>
    ...
    <div class="section section-header">
        <div class="parallax filter filter-color-white">
            <div class="image"
                style="background-image: url('assets/img/joe4.jpg')">
            </div>
            <div class="container">
                <div class="content">
                    <div class="title-area">
                        <p style="margin-top: 4 0px;"></p>
                        <h1 class="title-modern">We Are Here For You</h1>
                        
                        <div class="separator line-separator">♦</div>
                    </div>

                    <div class="button-get-started">
                        <a href="get.php" class="btn btn-white btn-fill btn-lg ">
                            Get An ipainter
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row"   >
                <div class="title-area">
                    ...
                    <p class="description">we will contact you as soon as we get your request</p>
                </div>
        </div>
    </div>
    ...
    <div class="section section-our-team-freebie">
        <div class="parallax filter">
            ...
            <div class="container">
                <div class="title-area">
                    <h2 class="text-white">Please fill the form below to get updates from us:</h2>
                </div>
